...
CREATE TABLE Kaffegård(
    GårdID INTEGER NOT NULL AUTO_INCREMENT,
    Navn     VARCHAR(30) NOT NULL,
...
CREATE TABLE Foredlingsmetode(
    ForedlingID INTEGER NOT NULL AUTO_INCREMENT,
    Navn     VARCHAR(30) NOT NULL,
...
CREATE TABLE  Kaffeparti (
    PartiID       INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Kaffe (
  ...
  CONSTRAINT Kaffe_FK1 FOREIGN KEY (BrenneriNavn) REFERENCES Kaffebrenneri(BrenneriNavn)
    ON UPDATE CASCADE
    ON DELETE CASCADE,
...
CREATE TABLE Kaffesmaking (
  SmakID      INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Kaffebønne(
    BønneID INTEGER NOT NULL AUTO_INCREMENT,
